...
{
    internal class PersonsList : IPersonList
    {
        ...
        public List<PersonModel> GetPersonsList()
        {
            ...
            persons.Add(new PersonModel() { Name = "Alexander Runge", Status = "Student", Subjects = new string[] { "Clientsideprogrammering", "Studieteknik", "Grundlæggende Programmering", "OOP", "Databaseprogrammering", "Computerteknologi", "Netværk" } });
            ...
            persons.Add(new PersonModel() { Name = "Mdh Adil Ajak", Status = "Student", Subjects = new string[] { "Clientsideprogrammering", "Studieteknik", "Grundlæggende Programmering", "OOP", "Databaseprogrammering", "Computerteknologi", "Netværk" } });
            ...
            persons.Add(new PersonModel() { Name = "Niels Olesen", Status = "Teacher", Subjects = new string[] { "Studieteknik", "Grundlæggende Programmering", "OOP", "Databaseprogrammering" } });
